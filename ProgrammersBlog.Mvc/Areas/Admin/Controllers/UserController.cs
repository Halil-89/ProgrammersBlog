...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public async Task<IActionResult>Add(UserAddDto userAddDto)
        {
            ...
            var uploadImageDtoResult = await ImageHelper.Upload (userAddDto.UserName, userAddDto.PictureFile,PictureType.User);
            userAddDto.Picture = uploadImageDtoResult.ResultStatus == ResultStatus.Succes
             ? uploadImageDtoResult.Data.FullName
            ...
            if (result.Succeeded)
            {
                var userAddAjaxModel = JsonSerializer.Serialize(new UserAddAjaxViewModel
                {
                    ...
                    {
                        ResultStatus = ResultStatus.Succes,
                        Message = $"{user.UserName} adlı kullanıcı adnız başarı ile eklenmiştir.",
                        User = user
        ...
        public async Task<JsonResult> Delete(int userId)
        {
            ...
            else
            {
                ...
                var deletedUserErrorModel = JsonSerializer.Serialize(new UserDto
                {
                    ...
                    Message = $"{user.UserName} adlı kullanıcıya ait kullanıcı silinirken hata oluştu.\n{errorMessages}",
                    User = user,
                });
        ...
        public async Task<IActionResult> Update(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var uploadImageDtoResult = await ImageHelper.Upload(userUpdateDto.UserName, userUpdateDto.PictureFile, PictureType.User);
                    userUpdateDto.Picture = uploadImageDtoResult.ResultStatus == ResultStatus.Succes
                     ? uploadImageDtoResult.Data.FullName
                     : "userImage/defaultUser.png";
        ...
        public async Task<ViewResult> ChangeDetails(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _toastNotification.AddSuccessToastMessage($"{updatedUser.UserName} adlı kullanıcı başarıyle güncellenmiştir.");
