...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(ICategoryService categoryService, IArticleService articleService, ICommentService commentService, UserManager<User> userManager = null)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (categoriesCountResult.ResultStatus==ResultStatus.Succes&&articlesCountResult.ResultStatus==ResultStatus.Succes
                &&commentsCountResult.ResultStatus==ResultStatus.Succes&&usersCount>-1
