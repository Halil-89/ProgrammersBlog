            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            const hardDeletedResult = jQuery.parseJSON(data);
                            console.log(hardDeletedResult);
                            if (hardDeletedResult.Data.ResultStatus === 0) {
                                Swal.fire(
                                    'Kalıcı olarak silindi.!',
                                    `${hardDeletedResult.Data.Message}`,
                                    'success'
                                );
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Başarısız İşlem!',
                                    text: `${hardDeletedResult.Data.Message}`,
                                });
                            }
                        },
                        error: function (err) {
